...
// Robot Configuration:
// [Name]               [Type]        [Port(s)]
// Topdriveright        motor         9               
// Topdrivemotorleft    motor         19              
// drivebackright       motor         10              
// drivebackleft        motor         20              
// drivefrontright      motor         7               
// drivefrontleft       motor         6               
// Intake               motor         18              
// Cata                 motor         8               
...
void set_Cata(int input) {
  Cata.spin(fwd, input * SCALE, voltageUnits::mV);
}
...
//Left Motors:
motor_group(Topdrivemotorleft, drivebackleft, drivefrontleft),

//Right Motors:
motor_group(Topdriveright, drivebackright, drivefrontright),
